<!DOCTYPE html>
<<<<<<< HEAD:resources/views/admin/role/role/list.blade.php
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td style="text-align: center;">
                                    <a href="/admin/role/auth/{{$v->id}}"  title="授权">
                                      <span class="iconfont icon-xxx">&#xe600;</span>
                                    </a>
                                    <a title="编辑"  onclick="xadmin.open('编辑','/admin/role/{{$v->id}}/edit')" href="javascript:;">
...
>>>>>>> origin/liang:resources/views/admin/upload/video/index.blade.php
</html>